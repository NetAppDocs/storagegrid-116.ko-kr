...
NOTE: 이 목록에는 로 구성할 수 있는 포트가 포함되어 있지 않습니다 xref:../admin/configuring-load-balancer-endpoints.adoc[부하 분산 장치 엔드포인트] 또는 에 사용됩니다 link:../monitor/configuring-syslog-server.html["Syslog 서버"].
