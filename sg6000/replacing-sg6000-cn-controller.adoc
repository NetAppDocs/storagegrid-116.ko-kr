...
+
** link:../sg6000/configuring-storagegrid-connections.html["StorageGRID 연결을 구성합니다"]
...
. BMC 네트워크 연결을 복원한 후 BMC 인터페이스에 연결하여 추가 사용자 정의 BMC 구성을 감사하고 복원합니다. 예를 들어, SNMP 트랩 대상 및 e-메일 알림에 대한 설정을 확인해야 합니다. 을 참조하십시오 link:configuring-bmc-interface-sg6000.html["BMC 인터페이스를 구성합니다"].
