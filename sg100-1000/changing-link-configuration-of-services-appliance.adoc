...
. 링크 구성을 원하는 대로 변경합니다.
+
옵션에 대한 자세한 내용은 을 참조하십시오 xref:configuring-network-links-sg100-and-sg1000.adoc[네트워크 링크를 구성합니다].
...
+
VLAN 설정을 변경한 경우 어플라이언스의 서브넷이 변경되었을 수 있습니다. 어플라이언스의 IP 주소를 변경해야 하는 경우 를 참조하십시오 xref:configuring-storagegrid-ip-addresses-sg100-and-sg1000.adoc[StorageGRID IP 주소를 구성합니다].
